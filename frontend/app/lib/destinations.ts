...
export const DESTINATIONS: Destination[] = [
  ...
  {
    id: 'scotland',
    country: 'Schotland', city: 'Edinburgh', emoji: '🏴󠁧󠁢󠁳󠁣󠁴󠁿',
    lat: 55.9, lng: -3.2,
    image: 'https://images.unsplash.com/photo-1506377247377-2a5b3b417ebb?w=600&q=80',
    flightHours: 2, bestMonths: 'Mei – Sep', avgPrice: '€€',
    climate: 'koud',
    types: ['cultuur', 'natuur', 'citytrip'],
    budgets: ['€€', '€€€'],
    durations: ['kort', 'middel'],
    accommodation: ['hotel', 'airbnb'],
    activities: ['wandelen', 'musea', 'whisky proeven'],
    vibe: ['discover', 'wellness'], pace: 4, luxury: 4,
    foodScene: ['finedining', 'koffie', 'wijn'],
    crowd: 'mix', distance: 'europe',
    dealbreakers: ['no-cold', 'no-city'],
  },
  {
    id: 'mexico',
    country: 'Mexico', city: 'Mexico-Stad', emoji: '🇲🇽',
    lat: 19.4, lng: -99.1,
    image: 'https://images.unsplash.com/photo-1518105779142-d975f22f1b0a?w=600&q=80',
    flightHours: 12, bestMonths: 'Nov – Apr', avgPrice: '€€',
    climate: 'warm',
    types: ['cultuur', 'citytrip', 'avontuur'],
    budgets: ['€', '€€'],
    durations: ['middel', 'lang'],
    accommodation: ['hotel', 'airbnb'],
    activities: ['musea', 'streetfood', 'wandelen'],
    vibe: ['discover', 'party'], pace: 7, luxury: 4,
    foodScene: ['streetfood', 'markt', 'finedining'],
    crowd: 'mix', distance: 'worldwide',
    dealbreakers: ['no-crowds'],
  },
  {
    ...
    country: 'Kroatië', city: 'Dubrovnik', emoji: '🇭🇷',
    lat: 42.6, lng: 18.1,
    image: 'https://images.unsplash.com/photo-1555990538-c90041993900?w=600&q=80',
    flightHours: 2.5, bestMonths: 'Mei – Sep', avgPrice: '€€',
    climate: 'warm',
    types: ['strand', 'cultuur', 'citytrip'],
    budgets: ['€€', '€€€'],
    durations: ['kort', 'middel'],
    accommodation: ['hotel', 'airbnb'],
    activities: ['zwemmen', 'wandelen', 'musea'],
    vibe: ['relax', 'discover'], pace: 5, luxury: 5,
    foodScene: ['finedining', 'markt', 'wijn'],
    crowd: 'tourist', distance: 'europe',
    dealbreakers: ['no-crowds', 'no-city'],
  ...
  {
    id: 'peru',
    country: 'Peru', city: 'Cusco', emoji: '🇵🇪',
    lat: -13.5, lng: -72.0,
    image: 'https://images.unsplash.com/photo-1526392060635-9d6019884377?w=600&q=80',
    flightHours: 14, bestMonths: 'Apr – Okt', avgPrice: '€€',
    climate: 'gematigd',
    types: ['avontuur', 'natuur', 'cultuur'],
    budgets: ['€', '€€'],
    durations: ['middel', 'lang'],
    accommodation: ['hotel', 'airbnb'],
    activities: ['wandelen', 'musea', 'trekking'],
    vibe: ['adventure', 'discover'], pace: 6, luxury: 3,
    foodScene: ['streetfood', 'markt', 'finedining'],
    crowd: 'mix', distance: 'worldwide',
    dealbreakers: ['no-adventure', 'no-cold'],
  },
  {
    id: 'singapore',
    country: 'Singapore', city: 'Singapore', emoji: '🇸🇬',
    lat: 1.3, lng: 103.8,
    image: 'https://images.unsplash.com/photo-1525625293386-3f8f99389edd?w=600&q=80',
    flightHours: 13, bestMonths: 'Feb – Apr, Jul – Sep', avgPrice: '€€€€',
    climate: 'warm',
    types: ['citytrip', 'cultuur'],
    budgets: ['€€€', '€€€€'],
    durations: ['kort', 'middel'],
    accommodation: ['hotel'],
    activities: ['musea', 'eten', 'shopping'],
    vibe: ['discover', 'wellness'], pace: 7, luxury: 9,
    foodScene: ['streetfood', 'finedining', 'markt'],
    crowd: 'mix', distance: 'worldwide',
    dealbreakers: ['no-city', 'no-crowds'],
  },
  {
    ...
    flightHours: 3.5, bestMonths: 'Mrt – Mei, Sep – Nov', avgPrice: '€€',
    climate: 'gematigd',
    types: ['cultuur', 'citytrip'],
    budgets: ['€', '€€'],
    durations: ['kort', 'middel'],
    accommodation: ['hotel', 'airbnb'],
    activities: ['musea', 'wandelen', 'bazaar'],
    vibe: ['discover', 'party'], pace: 8, luxury: 5,
    foodScene: ['streetfood', 'markt', 'finedining'],
    crowd: 'tourist', distance: 'europe',
    dealbreakers: ['no-crowds', 'no-city'],
  },
  {
    ...
    durations: ['kort', 'middel'],
    accommodation: ['hotel', 'airbnb'],
    activities: ['wandelen', 'northern lights', 'roadtrip'],
    vibe: ['adventure', 'wellness'], pace: 3, luxury: 5,
    foodScene: ['finedining', 'koffie'],
    crowd: 'offbeaten', distance: 'europe',
    dealbreakers: ['no-cold', 'no-adventure'],
  },
  {
    id: 'india',
    country: 'India', city: 'Rajasthan', emoji: '🇮🇳',
    lat: 27.0, lng: 74.2,
    image: 'https://images.unsplash.com/photo-1524492412937-b28074a5d7da?w=600&q=80',
    flightHours: 9, bestMonths: 'Okt – Mrt', avgPrice: '€',
    climate: 'warm',
    types: ['cultuur', 'avontuur', 'natuur'],
    budgets: ['€', '€€'],
    durations: ['middel', 'lang'],
    accommodation: ['hotel', 'airbnb'],
    activities: ['musea', 'wandelen', 'forten'],
    vibe: ['discover', 'adventure'], pace: 7, luxury: 4,
    foodScene: ['streetfood', 'markt'],
    crowd: 'mix', distance: 'worldwide',
    dealbreakers: ['no-crowds', 'no-adventure'],
  },
  {
    id: 'sweden',
    country: 'Zweden', city: 'Stockholm', emoji: '🇸🇪',
    lat: 59.3, lng: 18.1,
    image: 'https://images.unsplash.com/photo-1509356843151-3e7d96241e11?w=600&q=80',
    flightHours: 2.5, bestMonths: 'Jun – Aug', avgPrice: '€€€',
    climate: 'koud',
    types: ['cultuur', 'citytrip', 'natuur'],
    budgets: ['€€€', '€€€€'],
    durations: ['kort', 'middel'],
    accommodation: ['hotel', 'airbnb'],
    activities: ['musea', 'wandelen', 'design'],
    vibe: ['discover', 'wellness'], pace: 4, luxury: 7,
    foodScene: ['finedining', 'markt', 'koffie'],
    crowd: 'mix', distance: 'europe',
    dealbreakers: ['no-cold', 'no-city'],
  },
  {
    ...
    flightHours: 9, bestMonths: 'Jun – Okt', avgPrice: '€€€',
    climate: 'warm',
    types: ['avontuur', 'natuur'],
    budgets: ['€€€', '€€€€'],
    durations: ['middel', 'lang'],
    accommodation: ['hotel'],
    activities: ['safari', 'natuur', 'fotografie'],
    vibe: ['adventure', 'discover'], pace: 3, luxury: 6,
    foodScene: ['markt'],
    crowd: 'offbeaten', distance: 'worldwide',
    dealbreakers: ['no-adventure', 'no-city'],
  },
  {
    id: 'czechia',
    country: 'Tsjechië', city: 'Praag', emoji: '🇨🇿',
    lat: 50.1, lng: 14.4,
    image: 'https://images.unsplash.com/photo-1541849546-216549ae216d?w=600&q=80',
    flightHours: 2, bestMonths: 'Apr – Okt', avgPrice: '€€',
    climate: 'gematigd',
    types: ['cultuur', 'citytrip'],
    budgets: ['€', '€€'],
    durations: ['kort', 'middel'],
    accommodation: ['hotel', 'airbnb'],
    activities: ['musea', 'wandelen', 'uitgaan'],
    vibe: ['discover', 'party'], pace: 6, luxury: 4,
    foodScene: ['streetfood', 'markt', 'wijn'],
    crowd: 'tourist', distance: 'europe',
    dealbreakers: ['no-crowds', 'no-city'],
  },
  {
    id: 'newzealand',
    country: 'Nieuw-Zeeland', city: 'Queenstown', emoji: '🇳🇿',
    lat: -45.0, lng: 168.7,
    image: 'https://images.unsplash.com/photo-1507699622108-4be3abd695ad?w=600&q=80',
    flightHours: 22, bestMonths: 'Nov – Apr', avgPrice: '€€€€',
    climate: 'gematigd',
    types: ['avontuur', 'natuur'],
    budgets: ['€€€', '€€€€'],
    durations: ['lang'],
    accommodation: ['hotel', 'airbnb'],
    activities: ['wandelen', 'bungee springen', 'skiën', 'roadtrip'],
    vibe: ['adventure'], pace: 6, luxury: 5,
    foodScene: ['markt', 'finedining', 'wijn'],
    crowd: 'offbeaten', distance: 'worldwide',
    dealbreakers: ['no-adventure'],
  },
  {
    id: 'colombia',
    country: 'Colombia', city: 'Cartagena', emoji: '🇨🇴',
    lat: 10.4, lng: -75.5,
    image: 'https://images.unsplash.com/photo-1536625979259-1df40d6a3c39?w=600&q=80',
    flightHours: 11, bestMonths: 'Dec – Apr', avgPrice: '€€',
    climate: 'warm',
    types: ['strand', 'cultuur', 'avontuur'],
    budgets: ['€', '€€'],
    durations: ['middel', 'lang'],
    accommodation: ['hotel', 'airbnb'],
    activities: ['wandelen', 'dans', 'strand'],
    vibe: ['discover', 'party', 'relax'], pace: 5, luxury: 4,
    foodScene: ['streetfood', 'markt'],
    crowd: 'mix', distance: 'worldwide',
    dealbreakers: ['no-crowds'],
  },
